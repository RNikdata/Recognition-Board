...
color:white;'>
    ...
    def get_box_html1(award_name, winner_name, winner_id, photo_url, rising_stars, width, height):
        ...
        ">
        <!-- Award Title -->
        <div style='font-weight:bold; font-size:18px; margin-bottom:10px; background:#CFA203; color:#000000; padding:4px 8px; border-radius:6px; display:inline-block; text-align:left;'>
            🏆 {award_name}
        </div>
        ...
        <div style="flex:1; display:flex; flex-direction:column; align-items:flex-start; text-align:left;">
            ...
            <div style='font-size:14px; font-weight:bold; color:#EBF4FD;'>{winner_name}</div>
    ...
    def get_box_html(award_name, winner_name, winner_id, photo_url, width, height):
        ...
        <div style="
            ...
            margin: 5px 0;
        ">
            <div style='font-weight:bold;justify-content: flex-start; font-size:16px; margin-bottom:10px; background:#CFA203; color:#000000; padding:4px 8px; border-radius:6px; display:inline-block;text-align:left;'>
                🏆 {award_name}
            </div>
    ...
    def get_box_html_impact_multiple(award_name, winners, width, height):
        ...
        if not winners:
            ...
            <div style="width: {width}px; height: {height}px; background: transparent;
                ...
                <!-- Award Name -->
                <div style='font-weight:bold; font-size:20px; margin-bottom:10px; background:#CFA203; color:#000000; padding:4px 8px; border-radius:6px; display:inline-block; text-align:left;'>
                    🏆 {award_name}
                </div>
